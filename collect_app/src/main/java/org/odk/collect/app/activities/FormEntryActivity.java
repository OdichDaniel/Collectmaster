...
package org.odk.collect.app.activities;
...
import org.odk.collect.app.adapters.IconMenuListAdapter;
import org.odk.collect.app.adapters.model.IconMenuItem;
...
import org.odk.collect.app.dao.helpers.FormsDaoHelper;
import org.odk.collect.app.dao.helpers.InstancesDaoHelper;
import org.odk.collect.app.events.ReadPhoneStatePermissionRxEvent;
import org.odk.collect.app.events.RxEventBus;
import org.odk.collect.app.exception.JavaRosaException;
import org.odk.collect.app.external.ExternalDataManager;
import org.odk.collect.app.fragments.MediaLoadingFragment;
import org.odk.collect.app.fragments.dialogs.CustomDatePickerDialog;
import org.odk.collect.app.fragments.dialogs.NumberPickerDialog;
import org.odk.collect.app.fragments.dialogs.ProgressDialogFragment;
import org.odk.collect.app.fragments.dialogs.RankingWidgetDialog;
import org.odk.collect.app.listeners.AdvanceToNextListener;
import org.odk.collect.app.listeners.FormLoaderListener;
import org.odk.collect.app.listeners.FormSavedListener;
import org.odk.collect.app.listeners.PermissionListener;
import org.odk.collect.app.listeners.SavePointListener;
import org.odk.collect.app.logic.FormController;
import org.odk.collect.app.logic.FormInfo;
import org.odk.collect.app.preferences.AdminKeys;
import org.odk.collect.app.preferences.AdminSharedPreferences;
import org.odk.collect.app.preferences.GeneralKeys;
import org.odk.collect.app.preferences.GeneralSharedPreferences;
import org.odk.collect.app.preferences.PreferencesActivity;
import org.odk.collect.app.provider.FormsProviderAPI;
import org.odk.collect.app.provider.InstanceProviderAPI;
import org.odk.collect.app.tasks.FormLoaderTask;
import org.odk.collect.app.tasks.SaveFormIndexTask;
import org.odk.collect.app.tasks.SavePointTask;
import org.odk.collect.app.tasks.SaveResult;
import org.odk.collect.app.tasks.SaveToDiskTask;
import org.odk.collect.app.upload.AutoSendWorker;
import org.odk.collect.app.utilities.ActivityAvailability;
import org.odk.collect.app.utilities.ApplicationConstants;
import org.odk.collect.app.utilities.DependencyProvider;
import org.odk.collect.app.utilities.DialogUtils;
import org.odk.collect.app.utilities.FileUtils;
import org.odk.collect.app.utilities.ImageConverter;
import org.odk.collect.app.utilities.MediaManager;
import org.odk.collect.app.utilities.MediaUtils;
import org.odk.collect.app.utilities.SoftKeyboardUtils;
import org.odk.collect.app.utilities.TimerLogger;
import org.odk.collect.app.utilities.ToastUtils;
import org.odk.collect.app.views.ODKView;
import org.odk.collect.app.widgets.DateTimeWidget;
import org.odk.collect.app.widgets.QuestionWidget;
import org.odk.collect.app.widgets.RangeWidget;
import org.odk.collect.app.widgets.StringWidget;
...
import static org.odk.collect.app.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.odk.collect.app.utilities.PermissionUtils.checkIfStoragePermissionsGranted;
import static org.odk.collect.app.utilities.PermissionUtils.finishAllActivities;
import static org.odk.collect.app.utilities.PermissionUtils.requestReadPhoneStatePermission;
import static org.odk.collect.app.utilities.PermissionUtils.requestStoragePermissions;
...
public class FormEntryActivity extends CollectAbstractActivity implements AnimationListener,
    ...
    private void loadFromIntent(Intent intent) {
        ...
        if (uriMimeType == null && intent.hasExtra(EXTRA_TESTING_PATH)) {
        ...
        } else if (uriMimeType != null && uriMimeType.equals(InstanceProviderAPI.InstanceColumns.CONTENT_ITEM_TYPE)) {
            ...
            if (formCount < 1) {
                ...
                && uriMimeType.equals(FormsProviderAPI.FormsColumns.CONTENT_ITEM_TYPE)) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent intent) {
        ...
        if (resultCode == RESULT_CANCELED) {
            ...
            if (requestCode != ApplicationConstants.RequestCodes.HIERARCHY_ACTIVITY && getCurrentViewIfODKView() != null) {
        ...
        if (intent == null && requestCode != ApplicationConstants.RequestCodes.DRAW_IMAGE && requestCode != ApplicationConstants.RequestCodes.ANNOTATE_IMAGE
                && requestCode != ApplicationConstants.RequestCodes.SIGNATURE_CAPTURE && requestCode != ApplicationConstants.RequestCodes.IMAGE_CAPTURE
                && requestCode != ApplicationConstants.RequestCodes.HIERARCHY_ACTIVITY) {
        ...
        switch (requestCode) {
            ...
            case ApplicationConstants.RequestCodes.OSM_CAPTURE:
                ...
                saveAnswersForCurrentScreen(DO_NOT_EVALUATE_CONSTRAINTS);
                break;
            case ApplicationConstants.RequestCodes.EX_STRING_CAPTURE:
            case ApplicationConstants.RequestCodes.EX_INT_CAPTURE:
            case ApplicationConstants.RequestCodes.EX_DECIMAL_CAPTURE:
                String key = "value";
                ...
                break;
            case ApplicationConstants.RequestCodes.EX_GROUP_CAPTURE:
                try {
            ...
            case ApplicationConstants.RequestCodes.VIDEO_CAPTURE:
                ...
                break;
            case ApplicationConstants.RequestCodes.LOCATION_CAPTURE:
                ...
                saveAnswersForCurrentScreen(DO_NOT_EVALUATE_CONSTRAINTS);
                break;
            case ApplicationConstants.RequestCodes.GEOSHAPE_CAPTURE:
                ...
                saveAnswersForCurrentScreen(DO_NOT_EVALUATE_CONSTRAINTS);
                break;
            case ApplicationConstants.RequestCodes.GEOTRACE_CAPTURE:
                ...
                saveAnswersForCurrentScreen(DO_NOT_EVALUATE_CONSTRAINTS);
                break;
            case ApplicationConstants.RequestCodes.BEARING_CAPTURE:
                ...
                saveAnswersForCurrentScreen(DO_NOT_EVALUATE_CONSTRAINTS);
                break;
            case ApplicationConstants.RequestCodes.HIERARCHY_ACTIVITY:
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_goto:
                ...
                startActivityForResult(i, ApplicationConstants.RequestCodes.HIERARCHY_ACTIVITY);
                return true;
